import CLabel from '../overlay/CLabel'
...
export default {
  ...
  methods: {
    createLabel () {
      this.label = new window.CCLabel(this.latlng, this.$slots.default ? this.$el.innerHTML : this.text, { labelfontcolor: this.labelColor }, [this.offsetX || 0, this.offsetY || 0], null, this.className)
